...
data_merge <- data_merge %>% filter(ATTRIBUTE_Sample_Type != "Ext_Blank")

data_merge <- data_merge %>% filter(ATTRIBUTE_Sample_Type != "Pooled_QC")
...
ggsave(file="pca_biplot_neg_SMRW_01082025_no_QC.svg", plot=new_biplot, width=10, height=8)
...
ggsave(file="pca_SMRW_vs_NS_12182024_neg no QC.svg", plot=new_pca, width=10, height=8)
