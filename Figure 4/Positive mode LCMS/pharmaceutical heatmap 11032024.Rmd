...
clustered_4 <- clustered_1 %>%
   select(starts_with("5764_"), starts_with("10582_"), starts_with("9430_"), starts_with("7507_"), starts_with("12950_"), starts_with("7474_"), starts_with("7667_"), starts_with("2030_"), starts_with("8780_"), starts_with("13028_"), starts_with("8723_"), starts_with("33896_"), starts_with("7369_"), starts_with("9461_"), starts_with("2581_"), starts_with("34139_"), starts_with("20927_"), starts_with("4014_"), starts_with("8372_"), starts_with("42703_"), starts_with("5974_"), starts_with("1202_"),starts_with("8662_"),starts_with("7181_"), starts_with("19959_"),starts_with("12688_"),starts_with("25474_"), starts_with("15820_"), starts_with("3159_"), starts_with("5174_"),starts_with("29788_"),starts_with("18897_"), starts_with("3792_"), starts_with("5909_"),starts_with("2495_"),starts_with("10110_"),starts_with("5299_"),starts_with("34737_"),starts_with("3749_"),starts_with("3233_"),starts_with("27678_"),starts_with("14477_"),starts_with("21334_"),starts_with("23292_"),starts_with("18144_"),starts_with("20451_"),starts_with("15425_"),starts_with("16468_"),starts_with("13989_"))
```

```{r}
rownames(clustered_4)[rownames(clustered_4) == "A1.mzML"] <- "High Snowmaking March 2022 1"
rownames(clustered_4)[rownames(clustered_4) == "A2.mzML"] <- "High Snowmaking March 2022 2"
rownames(clustered_4)[rownames(clustered_4) == "A3.mzML"] <- "High Snowmaking March 2022 3"
rownames(clustered_4)[rownames(clustered_4) == "A4.mzML"] <- "High Snowmaking December 2022 1"
rownames(clustered_4)[rownames(clustered_4) == "A5.mzML"] <- "High Snowmaking December 2022 2"
rownames(clustered_4)[rownames(clustered_4) == "A6.mzML"] <- "High Snowmaking December 2022 3"
rownames(clustered_4)[rownames(clustered_4) == "A7.mzML"] <- "Low Snowmaking April 2023 1"
rownames(clustered_4)[rownames(clustered_4) == "A8.mzML"] <- "Low Snowmaking April 2023 2"
rownames(clustered_4)[rownames(clustered_4) == "A9.mzML"] <- "Low Snowmaking April 2023 3"
rownames(clustered_4)[rownames(clustered_4) == "A10.mzML"] <- "Natural Snowfall March 2022 1"
rownames(clustered_4)[rownames(clustered_4) == "A11.mzML"] <- "Natural Snowfall March 2022 2"
rownames(clustered_4)[rownames(clustered_4) == "A12.mzML"] <- "Natural Snowfall March 2022 3"
rownames(clustered_4)[rownames(clustered_4) == "A13.mzML"] <- "Natural Snowfall April 2023 1"
rownames(clustered_4)[rownames(clustered_4) == "A14.mzML"] <- "Natural Snowfall April 2023 2"
rownames(clustered_4)[rownames(clustered_4) == "A15.mzML"] <- "Natural Snowfall April 2023 3"
```
...
clustered_4 <- clustered_4 %>%
  ...
  rename_with(~ str_replace(., "^34737_.*", "Acarbose analog"))%>%
  rename_with(~ str_replace(., "^3749_.*", "Azithromycin analog "))%>%
  rename_with(~ str_replace(., "^3233_.*", "Bisoprolol analog"))%>%
  rename_with(~ str_replace(., "^27678_.*", "Oxandrolone analog"))%>%
  rename_with(~ str_replace(., "^14477_.*", "Rimantadine analog"))%>%
  rename_with(~ str_replace(., "^21334_.*", "Exemestane analog"))%>%
  rename_with(~ str_replace(., "^23292_.*", "Dydrogesterone analog"))%>%
  rename_with(~ str_replace(., "^18144_.*", "Enzacamene analog 1"))%>%
  rename_with(~ str_replace(., "^20451_.*", "Enzacamene analog 2"))%>%
  rename_with(~ str_replace(., "^15425_.*", "Enzacamene analog 3"))%>%
  rename_with(~ str_replace(., "^16468_.*", "Methyltestosterone analog 1"))%>%
  rename_with(~ str_replace(., "^13989_.*", "Methyltestosterone analog 2"))%>%
  rename_with(~ str_replace(., "^1202_.*", "Adenosine"))%>%
  rename_with(~ str_replace(., "^8662_.*", "Azelaic acid"))%>%
  rename_with(~ str_replace(., "^7181_.*", "Tyrosine"))%>%
  rename_with(~ str_replace(., "^19959_.*", "Ursodiol"))%>%
  rename_with(~ str_replace(., "^12688_.*", "Hydrocortisone"))%>%
  rename_with(~ str_replace(., "^25474_.*", "DGLA"))
...
lhei = c(1, 8),
lwid = c(1, 4),
          cexRow = 2,   # Increase row label size
          cexCol = 2)
dev.off()
...
svg("heatmap_plot_with_analogs_11192025.svg", width = 8, height = 10)  # Adjust width and height as needed
pheatmap(clustered_4_matrix, 
         scale = "row", 
         fontsize_row = 12, 
         fontsize_col = 12)
dev.off()
