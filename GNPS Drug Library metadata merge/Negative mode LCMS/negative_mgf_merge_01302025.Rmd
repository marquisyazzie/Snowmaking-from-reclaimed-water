...
```{r}
setwd("C:/Users/Marquis.Yazzie/OneDrive - University of Denver/Desktop/DU Research/SMRW project/nina_mgf_updated_01242025/negative ESI")
```
...
```{r}
LC_only <- read.csv("LC library only 01302025.csv", header = TRUE)

library_only <- read.csv("spectral mgf only 01302025.csv", header= TRUE)
