setwd("C:/Aron_Lab_Data/SMRW_vs_NS_project/Data_Cleanup_Results/average_technical_replicates_mzmine_10292023_pos_mode_data_cleanup")
...
ft <- read.csv('FEATURE_AVERAGE_OF_TWO_TECHNICAL_REPLICATES_mzmine_2_0929_2023_iimn_gnps_quant 1.csv', header = T, check.names = F)
md <- read.csv('average_technical_replicates_metadata_10292023_pos_mode.csv', header = T, check.names = F, sep = ',')
...
write.csv(new_md, "metadata_feature_average_technical_replicates_10292023_SMRW_vs_NS_pos.csv",row.names = TRUE)

new_md <- read_csv('metadata_feature_average_technical_replicates_10292023_SMRW_vs_NS_pos.csv') %>% column_to_rownames("filename")
new_md <- new_md[, -1]
...
write.csv(new_md, 'metadata_feature_average_technical_replicates_10292023_SMRW_vs_NS_pos_with_blanksplit.csv', row.names=TRUE)
...
write.csv(Blank_removal,file.path(paste0('average_technical_replicates_mzmine_3_10292023_pos_blank_removed_features.csv')),row.names =TRUE)
...
write.csv(Imputed,file.path(paste0('average_technical_replicates_mzmine_3_10292023_pos_',Cutoff_LOD,'_CutOff_Used_',Cutoff,'_07282023.csv')),row.names =TRUE)
...
write.csv(Normalized_data_TIC, file.path('average_technical_replicates_mzmine_3_10292023_pos_Normalised_Quant_table_pos.csv'),row.names =TRUE)
...
write.csv(Imp_clrt, "average_technical_replicates_mzmine_3_10292023_pos_CLR_Scaled_positive.csv",row.names = TRUE)

################## Multivariate Statistical Analysis - Principal Component Analysis - PCA ############################
library("FactoMineR")

metadata_pos <- read_csv("metadata_feature_average_technical_replicates_10292023_SMRW_vs_NS_pos_with_blanksplit.csv")
clr_ft_pos <- read_csv("average_technical_replicates_mzmine_3_10292023_pos_CLR_Scaled_positive.csv")
...
pca
ggsave(file="High_and_Low_SMRW_average_technical_replicates_PCA_pos_mode10292023.svg", plot=pca, width=10, height=8)
