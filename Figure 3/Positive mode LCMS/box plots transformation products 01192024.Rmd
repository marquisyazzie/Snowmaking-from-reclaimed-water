...
```{r}
setwd("C:/Users/Marquis.Yazzie/OneDrive - University of Denver/Desktop/Aron_Lab_Data/SMRW_vs_NS_project/Kruskal_wallis_with_Normalized_Peak_area_annotations/avg_tech_no_norm__09032025_KW_box_plot")
```
...
```{r}
quant <- read.csv("avg_tech_reps_mzmine_3_10292023_imputed.csv", header=T, check.names=F)
...
```{r}
y_columns <- c("5764", "10582","9430","7507","12950","7474","7667","2030", "8780", "13028","8723","33896","7369", "9461","2581","34139","20927","4014", "8372", "42703","5974","1202", "8662", "7181", "19959", "12688","25474","15820", "3159", "5174", "29788", "18897","3792","5909","2495","10110","5299", "34737", "3749", "3233", "27678", "14477","25740","21334","23292","18144", "20451","15425","16468", "13989")
```
...
plot_list <- lapply(y_columns, function(y_var) {
  ...
  ggplot(data_merge, aes(x = ATTRIBUTE_Sample_Type, y = .data[[y_var]], 
    ...
    theme_classic() + 
    labs(y = paste("Peak Area -", y_var), x = "Sample Type") +
...
write.csv(dunn_results_df,"dunn_result.csv")
```
